...
(function () {
  ...
  // Tap any project photo to view it full-screen; arrows / swipe / keyboard
  // move through that project's images. Esc, the X, or the backdrop close it.
  ...
  if (lb) {
    ...
    lb.addEventListener('pointerdown', (e) => { sx = e.clientX; tracking = true; });
